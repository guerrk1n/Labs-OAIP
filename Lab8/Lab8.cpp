...
int main()
{
    ...
    cout << setw(8) << "x" << setw(15) << "y(x)" << setw(25) << "iterations" << endl;
    output(-1, 1.3, 0.1, 10e-5, decomposition_y);
    cout << endl;
    cout << setw(8) << "x" << setw(15) << "s(x)" << setw(25) << "iterations" << endl;
...
void output(double a, double b, double h,double e, pointer pntr) {
    ...
    for (double x = a; x <= b+h/2; x += h) {
        ...
        cout << setw(8) << x << setw(15) << sum << setw(25) << iterations_number << endl;
    }
